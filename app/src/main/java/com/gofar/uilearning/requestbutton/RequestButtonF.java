package com.gofar.uilearning.requestbutton;
 ...
 */
public class RequestButtonF extends LinearLayout implements View.OnClickListener, OnIconChangedListener {

    public static final String TAG = RequestButtonF.class.getSimpleName();
    /**
    ...
    public RequestButtonF(Context context) {
        super(context);
        init(context, null);
    }

    public RequestButtonF(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RequestButtonF(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RequestButtonF(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setIconSpacing(int iconSpacing) {
        ...
        ((LayoutParams) icon.getLayoutParams()).setMargins(0, 0, iconSpacing, 0);
    }
